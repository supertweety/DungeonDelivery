...
Question 1: What is the state space searched by your agent? Does it include position, keys, carried package, or delivered packages?

Question 2: What heuristic does your agent use? Is it admissible? Does admissibility matter for your tournament strategy?

Question 3: Why can BFS perform poorly when mud and traps are present?

Question 4: Why is replanning after every move important in this shared-board setting?

Question 5: How does your agent decide between a nearby low-value package and a distant high-value package?

Question 6: Why does the default search problem not need to treat other agents as obstacles?

## Academic Honesty

Students may discuss ideas, but should write and understand their own code. You must be able to explain your implementation, including its state representation, heuristic, and target-selection strategy.
